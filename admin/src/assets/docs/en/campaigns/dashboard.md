...
A button allows you to download the information in the Dashboard as a PDF. This provides a direct overview of the results generated by FORMIGA.

#### Download the disaggregated data

To enable further analysis of participants’ responses, we offer the option to download the data line by line in _.csv_ format (which remains anonymous). However, the processing of this data must be carried out in accordance with current regulations, outside the scope of FORMIGA.
